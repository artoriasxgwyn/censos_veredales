...
onMounted(async () => {
  // Verificar permiso para ver residentes (read es suficiente para ver detalle)
  if (!authStore.hasPermission('resident', 'read')) {
    $q.notify({
      type: 'negative',
      message: 'Acceso denegado. No tienes permisos para ver residentes.'
    })
